...
public class OrderItemParamVo implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof OrderItemParamVo)) return false;
        final OrderItemParamVo other = (OrderItemParamVo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OrderItemParamVo;
    }
    ...
    public String toString() {
        return "OrderItemParamVo(skuType=" + this.getSkuType() + ", skuId=" + this.getSkuId() + ", skuNum=" + this.getSkuNum() + ")";
    }
}